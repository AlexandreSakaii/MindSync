...
<div class="bg-white py-24 sm:py-32">
    <div class="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div class="container mx-auto mt-16 rounded-3xl  sm:mt-20">
            @foreach($planos as $plano)
                <div class="flex flex-col lg:flex-row mb-10 bg-white shadow-lg rounded-lg p-6">
                    <div class="p-8 sm:p-10 lg:flex-auto">
                        <h3 class="text-2xl font-bold tracking-tight text-gray-900">{{ $plano->nome }}</h3>
                        <p class="mt-6 text-base leading-7 text-gray-600">{{ $plano->descricao }}</p>
                    ...
                    <div class="p-8 sm:p-10 lg:w-full lg:max-w-md lg:flex-shrink-0 lg:flex lg:flex-col lg:justify-center lg:items-center bg-gray-50 rounded-2xl">
